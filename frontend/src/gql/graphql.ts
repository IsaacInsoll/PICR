...
export type ViewAdminsQueryQuery = { __typename?: 'Query', admins: Array<{ __typename?: 'User', id: string, name: string, enabled: boolean, uuid?: string | null, folderId: string, folder?: { __typename?: 'Folder', id: string, name: string } | null }> };
