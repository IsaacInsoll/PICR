...
export type ServerInfoQueryQuery = { __typename?: 'Query', serverInfo?: { __typename?: 'ServerInfo', version: string, databaseUrl: string, dev: boolean, usePolling: boolean, cacheSize: any, mediaSize: any } | null };
