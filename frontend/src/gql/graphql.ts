...
export type ViewAdminsQueryQuery = { __typename?: 'Query', admins: Array<{ __typename?: 'User', username?: string | null, id: string, name: string, enabled: boolean, uuid?: string | null, folderId: string, folder?: { __typename?: 'Folder', id: string, name: string, parents: Array<{ __typename?: 'Folder', id: string, name: string }> } | null }> };
