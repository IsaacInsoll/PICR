...
export type ManageFolderQueryQuery = { __typename?: 'Query', folder: { __typename?: 'Folder', id: string, name: string }, publicLinks: Array<{ __typename?: 'PublicLink', folderId: string, id: string, name: string, availableFrom: string, availableTo: string, enabled: boolean, uuid: string, folder: { __typename?: 'Folder', id: string, name: string } }> };
...
export type PublicLinkFragmentFragment = { __typename?: 'PublicLink', id: string, name: string, availableFrom: string, availableTo: string, enabled: boolean, uuid: string, folderId: string, folder: { __typename?: 'Folder', id: string, name: string } };
