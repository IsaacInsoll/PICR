...
export type FileFragmentFragment = { __typename?: 'File', id: string, name: string, type: FileType, imageRatio?: number | null, duration?: number | null, fileHash: string, fileSize: any };
