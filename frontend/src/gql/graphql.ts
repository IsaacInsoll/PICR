...
export type EditPublicLinkMutationMutation = { __typename?: 'Mutation', editUser: { __typename?: 'User', id: string, name: string, username?: string | null, enabled: boolean, uuid?: string | null, folderId: string, folder?: { __typename?: 'Folder', id: string, name: string, parents: Array<{ __typename?: 'Folder', id: string, name: string }> } | null } };
