...
export type SearchQueryQuery = { __typename?: 'Query', searchFolders: Array<{ __typename: 'Folder', id: string, name: string, parentId?: string | null, permissions?: FolderPermissions | null, parents: Array<{ __typename?: 'Folder', id: string, name: string }> }>, searchFiles: Array<{ __typename: 'File', id: string, name: string, type: FileType, fileHash: string, fileSize: any, fileLastModified: any, flag?: FileFlag | null, rating?: number | null, totalComments?: number | null, latestComment?: any | null, folderId: string, folder?: { __typename: 'Folder', id: string, name: string, parentId?: string | null } | null }> };
