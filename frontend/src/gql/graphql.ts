...
export type TaskQueryQueryVariables = Exact<{ [key: string]: never; }>;


export type TaskQueryQuery = { __typename?: 'Query', tasks: Array<{ __typename?: 'Task', id?: string | null, name: string, step: number, totalSteps: number }> };
