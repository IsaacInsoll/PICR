...
UPDATE "Users" SET "user_type" = 'Link' where "userType" is null and "uuid" is not null;
UPDATE "Users" SET "user_type" = 'Admin' where "userType" is null and "hashedPassword" is not null;
