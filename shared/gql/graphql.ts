...
export type MinimumFolderFragmentFragment = { __typename: 'Folder', id: string, name: string, parentId?: string | null, heroImage?: { __typename?: 'Image', id: string, name: string, fileHash: string, imageRatio?: number | null, blurHash: string, type: FileType } | null };
