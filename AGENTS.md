...
## Autogenerated files
The following files are autogenerated and should not directly be edited. 
- ./graphql-types.ts
- ./schema.graphql
- shared/urql/graphql.schema.json
- shared/gql/*

If you update the schema (backend) or update the queries/mutations in URQL (shared) then run `npm run gql` to regenerate these files
