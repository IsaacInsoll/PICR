...
export const AppFolderGalleryList2 = ({
  items,
  width,
  refresh,
  colCount,
  ...
  //TODO: convert to ZoomGrid format
  const photos = items.map((i) => i);

  return (
    <ZoomGrid
      data={photos}
      initialNumColumns={3}
      zoomLevels={[7, 5, 3, 2, 1]} // Columns for each zoom level
      ...
      renderHeader={() => <PTitle>Header here</PTitle>}
    />
    // <FlashList
    //   onRefresh={refresh}
    //   onLayout={(e) => {
